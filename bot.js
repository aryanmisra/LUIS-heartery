...
const AGE_INTENT = 'Age' //new intent /
const CHOLESTEROL_INTENT = 'Cholesterol' //new intent /
const DIABETES_INTENT = 'Diabetes' //new intent
const HEARTBURN_INTENT = 'Heartburn' //new intent
const SMOKE_INTENT = 'Smoke' //new intent /
const WEIGHT_INTENT = 'Weight' //new intent /
const CHESTPAINS_INTENT = 'chestpains' //new intent
const NAUSEA_INTENT = 'nausea' //new intent
const HYPERTENSION_INTENT = 'Hypertension' //new intent /
                    ...
                    case DialogTurnStatus.empty:
                        ...
                        switch (topIntent) {
                            ...
                            case AGE_INTENT: 
                                ...
                                await dc.context.sendActivity(`Great! How much do you weigh?`);
                                break;

                            case WEIGHT_INTENT: 

                                await dc.context.sendActivity(`Cool, do you smoke?`);
                                break;

                            case SMOKE_INTENT: 

                                await dc.context.sendActivity(`Alright, do you have high cholesterol?`);
                                break;

                            case CHOLESTEROL_INTENT: 

                                await dc.context.sendActivity(`Okay, do you have a history of hypertension?`);
                                break;

                            case HYPERTENSION_INTENT: 

                                await dc.context.sendActivity(`Got it, do you have diabetes?`);
                                break;
                            

                            case DIABETES_INTENT: 

                                await dc.context.sendActivity(`Next, do you get chest pains?`);
                                break;

                            case CHESTPAINS_INTENT: 

                                await dc.context.sendActivity(`Alright, do you ever get nausea?`);
                                break;

                            case NAUSEA_INTENT: 

                                await dc.context.sendActivity(`Thanks, this is the last question! Do you ever get heartburn?`);
                                break;

                            case HEARTBURN_INTENT: 

                                await dc.context.sendActivity(`Awesome! We're finished the diagnostic, here are your results: <RESULTS>`);
                                break;
                            }
