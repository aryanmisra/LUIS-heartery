...
class Greeting extends ComponentDialog {
    ...
    async promptForNameStep(step) {
        ...
        if (!userProfile.name) {
            ...
            return await step.prompt(NAME_PROMPT, `Hey, nice to meet you! My name is Heather, what's your name?`);
        } else {
            return await step.next();
        }
    }
    ...
    async greetUser(step) {
        ...
        await step.context.sendActivity(`How old are you?`);
